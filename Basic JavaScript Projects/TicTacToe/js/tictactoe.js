...
function placeXOrO(squareNumber) {
    ...
    function checkWinConditions() {
        ...
        function arrayIncludes(squareA, squareB, squareC) {
            ...
            // If the 3 varibales we pass are all included in our array true is
...
// This line accesses our html canvas element.
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        // This line indicates where the end of a lines x asix is.
        x2 = coordX2,
        //This line indicates where the end of a lines x axis is.
        y2 = coordY2,
        // This variable stores temporary x axis data we update in our animatino loop.
        x = x1,
    ...
    // This line disallows clicking while the win sound is playhing.
    disableClick();
    // This line plays the win sounds.
    audio('./media/winGame_new.wav');
...
// This function resets the game in the evnet of a tie or a win.
function resetGame() {
